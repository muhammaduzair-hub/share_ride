...
class AuthView extends StatelessWidget {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Image(image: AssetImage("asset/images/logo.jpeg"),width: double.infinity,height: 100,)),
  ...
  Widget signIn(BuildContext context, Size size){
    return BaseWidget<LoginViewModel>(  //we use signup model for both
      model: LoginViewModel(authRepository: Provider.of(context, listen: false)),
      builder: (context, model, child) =>SafeArea(
        child: Scaffold(
          backgroundColor: Colors.white,
          appBar: AppBar(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      UIHelper.verticalSpaceSmall,
                      CustomTextField(controller: snumberController,),
                      ...
                      Container(
                        ...
                        PrimaryButton(
                          ...
                          ontap:() async {
                              ...
                              bool emailAns=model.onlyValidateEmail(snumberController.text);
                              if(passAns && emailAns){
                                //Send Data to a method inside Model Class to access Database
                                await model.signin( snumberController, spasswordController);
                                if(model.signedIdnUser.id==''){
                                  LoginViewModel.showToast("Invalid Username or Password");
                                }
                                else {
                                  Navigator.push(context, new MaterialPageRoute(
                                      builder: (context) => new VerifyCodeView())
